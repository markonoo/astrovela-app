...
interface Year2028PhotoReplicaProps {
  pageNumber: number
}

export function Year2028PhotoReplica({ pageNumber }: Year2028PhotoReplicaProps) {
  return (
    <div className="h-full relative overflow-hidden">
      {/* Full-page background image */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: 'url(/year-2028-mountain-lake.jpg)' }}
      />

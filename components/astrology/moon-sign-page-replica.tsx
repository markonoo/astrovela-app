...
export function MoonSignPageReplica({ pageNumber }: { pageNumber: number }) {
  return (
    <div className="h-full bg-black flex flex-col text-amber-200">
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center w-full px-12">
          ...
          {/* Moon image in frame - increased by 10%, centered */}
          <div className="mx-auto mb-16 relative flex items-center justify-center" style={{ width: '552px', height: '552px' }}>
            ...
            <img src="/moon-sign-cover.png" alt="Moon Sign" className="relative z-10 object-contain" style={{ width: '660px', height: '660px' }} />
          </div>
          ...
          <div className="w-full flex justify-center">
            <p className="text-base leading-relaxed font-medium tracking-[0.15em] font-serif text-center">
              The Moon governs your emotional landscape,<br />
              instincts, and subconscious, reflecting moods,<br />
              feelings, and nurturing tendencies.
            </p>
          </div>
        </div>
      </div>

...
export function ChironPageReplica({ pageNumber }: { pageNumber: number }) {
  return (
    <div className="h-full bg-black flex flex-col text-amber-200">
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center w-full px-12">
          ...
          {/* Chiron image - increased by 10%, centered */}
          <div className="mx-auto mb-16 relative flex items-center justify-center" style={{ width: '589px', height: '589px' }}>
            ...
            <img src="/chiron-cover.png" alt="Chiron" className="relative z-10 object-contain" style={{ width: '706px', height: '706px' }} />
          </div>
          ...
          <div className="w-full flex justify-center">
            <p className="text-base leading-relaxed font-medium tracking-[0.15em] font-serif text-center">
              Chiron symbolizes the "wounded healer," representing<br />
              areas of deep-seated wounds and the capacity for heal-<br />
              ing, showing how you can learn from your past pain<br />
              and help others with similar struggles.
            </p>
          </div>
        </div>
      </div>

...
interface Year2027PhotoReplicaProps {
  pageNumber: number
}

export function Year2027PhotoReplica({ pageNumber }: Year2027PhotoReplicaProps) {
  return (
    <div className="h-full relative overflow-hidden">
      {/* Full-page background image */}
      <img 
        src="/year-2027-photo.jpg" 
        alt="Year 2027 - Desert night sky with stars" 

...
interface Year2026PhotoReplicaProps {
  pageNumber: number
}

export function Year2026PhotoReplica({ pageNumber }: Year2026PhotoReplicaProps) {
  return (
    <div className="h-full relative overflow-hidden">
      {/* Full-page background image */}
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: 'url(/year-2026-mountain-night.jpg)' }}
      />

      {/* Year text with decorative elements - matching 2027 style */}

...
const navItems = [
  { href: "/aura", label: "Today", icon: Home },
  { href: "/aura/love", label: "Love", icon: Heart },
  { href: "/aura/career", label: "Career", icon: Briefcase },
  { href: "/aura/explore", label: "Explore", icon: BookOpen },
  { href: "/aura/report", label: "My Report", icon: BookOpen },
]
    ...
    <>
      ...
      <nav className="hidden md:flex fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-apple-gray-4/50 shadow-apple-sm">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            <Link href="/aura" className="flex items-center space-x-2 hover:opacity-80 transition-opacity duration-150">
              <span className="text-[20px] leading-[28px] font-bold text-apple-gray-1">AstroVela</span>
              <span className="text-[15px] leading-[20px] text-apple-gray-2">Aura</span>
            </Link>
      ...
      <nav className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-xl border-b border-apple-gray-4/50 shadow-apple-sm">
        <div className="flex items-center justify-between h-16 px-5">
          <Link href="/aura" className="flex items-center space-x-2">

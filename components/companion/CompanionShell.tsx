...
type CompanionTab = "horoscope" | "compatibility" | "palm" | "mood" | "ask-ai"
...
export function CompanionShell({ title, activeTab, children }: CompanionShellProps) {
  const { user } = useUser()

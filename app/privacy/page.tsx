  ...
  return (
    <PageLayout title="Privacy Policy" description="Learn how we collect, use, and protect your personal information">
      <div className="bg-white rounded-lg shadow-sm p-6 prose prose-slate max-w-none">
        ...
        <p>
          At Nordastro, we respect your privacy and are committed to protecting your personal data. This Privacy Policy
        ...
        <p>
          If Nordastro is involved in a merger, acquisition, or sale of all or a portion of its assets, your information
        ...
        <ul>
          <li>
            By email: <a href="mailto:privacy@nordastro.com">privacy@nordastro.com</a>
          </li>
          <li>By mail: Nordastro Privacy Office, 123 Astrology Lane, Starfield, CA 12345, USA</li>
        </ul>

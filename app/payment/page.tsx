    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 py-8">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-0 overflow-hidden border border-gray-200">
        ...
        <div className="flex flex-col items-center py-6">
          ...
          <span className="font-semibold text-lg text-gray-800">nordastro</span>
        </div>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="bg-gray-100 rounded-lg p-4 text-sm text-gray-700 mb-4 space-y-2">
            ...
            <div className="flex items-start gap-2">
              ...
              <span>You may cancel your subscription at any time by dropping us an email at <a href="mailto:help@nordastro.com" className="underline">help@nordastro.com</a></span>
            </div>
          </div>
        ...
        {/* Footer */}
        <div className="bg-gray-50 text-center text-xs text-gray-500 py-4 border-t border-gray-200">
          © 2025 Nordastro. All rights reserved.
        </div>
      </div>
    </div>
  )

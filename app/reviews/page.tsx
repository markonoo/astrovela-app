...
const reviewsData = [
  {
    ...
    content:
      "I got Nordastro book for my birthday, and it's been an incredible journey of self-discovery since. I use it daily with my friends to really understand what's happening in our lives. The insights about my career path were spot-on and helped me make a decision I was struggling with for months.",
  ...
  },
  {
    ...
    content:
      "I've read many astrology books before, but none as personalized and detailed as Nordastro. The way it breaks down my birth chart and explains the influences of each planet is incredibly insightful. I've been recommending it to all my friends!",
    imageSrc: "/placeholder.svg?height=50&width=50",
  },
  {
    id: 5,
...
export default function ReviewsPage() {
  ...
  return (
    <PageLayout
      ...
      description="See what our community has to say about their Nordastro experience"
    >
      ...
      <div className="bg-yellow-50 rounded-lg p-6 my-8 text-center">
        <h2 className="text-xl font-bold mb-2">Share your experience with Nordastro</h2>
